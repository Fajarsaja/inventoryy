    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Event <sup></sup> </p>
          <?php
            $kd = $_GET['id'];
			$sql = mysqli_query($koneksi, "SELECT * FROM user WHERE id='$kd'");
			...
			if(isset($_POST['update'])){
				...
				$update = mysqli_query($koneksi, "UPDATE user SET username='$username', fullname='$fullname', level='$level' WHERE id='$id'") or die(mysqli_error());
				if($update){
            ...
            <div class="card-body">
              ...
              <form class="form-horizontal style-form" action="input-user.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <input name="password" type="text" id="password" class="form-control" value="<?php echo $row['password']; ?>" placeholder="Password" autocomplete="off" readonly="readonly" />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <input name="fullname" type="text" id="fullname" class="form-control" value="<?php echo $row['fullname']; ?>" placeholder="Fullname" autocomplete="off" required />
                              </div>
                          </div>
