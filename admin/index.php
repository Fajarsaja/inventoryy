      ...
      <div id="content">
        ...
        <div class="container-fluid">
         <!-- Page Heading -->
          ...
          <p class="mb-4">Inventory 174 MOTOR <sup></sup> </p>
          <a href="input-transaksi-masuk.php" class="btn btn-lg btn-success" style="height: 100px; width 150px; margin-right:20px; margin-top: 10px;" ><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Transaksi Masuk&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a> 
