          ...
          <?php
			...
			if(isset($_POST['proses'])){
                ...
                //if(isset($_POST['status']) == "In"){
                     ...
                     VALUES('$id', '$date', '$id_pallet', '$rack_no', '$part_no', '$qty', '$unit', '$status2')") or die(mysqli_error($koneksi));
            ...
            <div class="card-body">
              ...
              <form class="form-horizontal style-form" action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-2">
                                  <input name="status2" type="text" id="status2" class="form-control" value="<?php echo $stat; ?>" readonly="readonly"  />
                              </div>
                          </div>
