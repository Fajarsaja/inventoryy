        ...
        <div class="container-fluid">
          ...
          <?php
			...
			if(mysqli_num_rows($sql) == 0){
                ...
                $sql1 = mysqli_query($koneksi, "SELECT * FROM transaksi WHERE rack_no='$kd'");
			...
			if(isset($_POST['proses'])){
             ...
             if(mysqli_num_rows($sql) == 0){
				...
				$row = mysqli_fetch_assoc($sql);
                    ...
                    $delete = mysqli_query($koneksi, "DELETE FROM transaksi WHERE rack_no='$rack_no1'");
                    ...
                    if($delete&&$qu1){
                         ...
                         $histori_transaksi1 = mysqli_query($koneksi, "INSERT INTO histori_transaksi(id, tanggal, id_pallet, rack_no, part_no, qty, unit, status)
                         VALUES('$id1', '$date1', '$id_pallet1', '$rack_no1', '$part_no1', '$qty1', '$unit1', '$status')") or die(mysqli_error());
            ...
            <div class="card-body">
              ...
              <form class="form-horizontal style-form" action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                  <input name="part_no" type="text" id="part_no" class="form-control" value="<?php echo $row1['part_no']; ?>" readonly="readonly" placeholder="Part No" autocomplete="off"  />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                  <input name="qty" type="number" id="qty" class="form-control" value="<?php echo $row1['qty']; ?>" placeholder="QTY" readonly="readonly"/>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-2">
                                  <input name="status1" type="text" id="status1" class="form-control" value="<?php echo $stat; ?>" readonly="readonly"  />
                              </div>
                          </div>
