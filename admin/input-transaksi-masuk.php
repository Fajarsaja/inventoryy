    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Transaksi masuk</h1>
          <p class="mb-4">Inventory <sup></sup> </p>
          <?php
...
$entry       = $_SESSION['fullname'];
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Input Transaksi Barang masuk</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
              <form class="form-horizontal style-form" action="input-transaksi-masuk.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
